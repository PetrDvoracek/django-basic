...
Example::
    ...
    >>> #     './www.google.com/index_ojan.html'
    >>> # opens the file and returns a file object.
    >>> fp = ds.open('http://www.google.com/index_ojan.html')
    >>>
...
class DataSource(object):
    ...
    will fail::
        ...
        >>> repos = DataSource()
        >>> repos.exists('www.google.com/index_ojan.html')
        False
        >>> repos.exists('http://www.google.com/index_ojan.html')
        True
    ...
    ::
        ...
        >>> urlname = 'http://www.google.com/index_ojan.html'
        >>> gfile = ds.open('http://www.google.com/index_ojan.html')  # remote file
        >>> ds.abspath(urlname)
        '/home/guido/www.google.com/site/index_ojan.html'
